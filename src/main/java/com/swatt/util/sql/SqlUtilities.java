...
public class SqlUtilities {
    ...
    private static final String allDrivers[] = { JDBC_ODBC_DRIVER_CLASS_NAME, MYSQL_DRIVER_CLASS_NAME, SQL_LITE_DRIVER_CLASS_NAME, H2_DRIVER_CLASS_NAME };
    ...
    static {
        ...
        driverMap.put("h2", H2_DRIVER_CLASS_NAME);
    }
    ...
    public static void loadH2Driver() throws OperationFailedException {
        loadByClass(H2_DRIVER_CLASS_NAME);
    }
